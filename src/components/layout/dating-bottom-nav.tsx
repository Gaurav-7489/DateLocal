...
export function DatingBottomNav() {
  ...
  if (hide) return null;
  return <>
    <header className="fixed inset-x-0 top-0 z-[90] border-b border-zinc-100 bg-white/95 backdrop-blur-xl md:hidden">
      <div className="mx-auto flex h-14 max-w-md items-center justify-between px-4">
        <Link href={routes.discover} aria-label="Extrovert home" className="text-[21px] font-black tracking-tight text-zinc-950">Extrovert</Link>
    ...
    <nav aria-label="Extrovert navigation" className="fixed inset-x-0 bottom-0 z-[80] border-t border-zinc-200 bg-white/95 pb-[env(safe-area-inset-bottom)] backdrop-blur-xl md:hidden">
