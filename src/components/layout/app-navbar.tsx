...
export function AppNavbar({
  ...
  return (
    <>
        ...
        >
          ...
          <div className="flex items-center gap-2 md:hidden">
            <button
              ...
              className="absolute left-1/2 -translate-x-1/2 flex h-10 w-10 items-center justify-center rounded-full border border-zinc-200 bg-white/90 text-zinc-700 shadow-sm backdrop-blur-md transition-all active:scale-95"
            ...
            {isSuperAdmin && (
              <Link
                href={routes.admin.root}
                className="flex h-10 w-10 items-center justify-center rounded-full border border-zinc-900 bg-zinc-900 text-white transition-all active:scale-95"
      ...
      {/* Mobile Bottom Navigation (Rendered via Portal to body) */}
      {mounted &&
        createPortal(
          <nav
