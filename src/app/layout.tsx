...
export const viewport: Viewport = { themeColor: "#ff4f8a", width: "device-width", initialScale: 1, viewportFit: "cover" };
export const metadata: Metadata = { title: `${universityConfig.appName} — Extrovert Date`, description: `Local dating built on your verified Extrovert identity.`, manifest: "/manifest.json", icons: { icon: [{ url: "/extrovert-date.svg", sizes: "any", type: "image/svg+xml" }, { url: "/icon-192.png", sizes: "192x192", type: "image/png" }], apple: "/icon-192.png" }, appleWebApp: { capable: true, title: universityConfig.appName, statusBarStyle: "default" } };
