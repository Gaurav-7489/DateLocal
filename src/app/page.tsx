        ...
        <section className="flex flex-1 items-center py-14 sm:py-20">
          <div className="w-full">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mx-auto inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-4 py-2 text-[11px] font-black text-emerald-700 shadow-sm">
              ...
              <h1 className="mt-7 text-4xl font-black tracking-[-0.04em] sm:text-6xl lg:text-7xl">We&apos;re making DateBu<br /><span className="text-emerald-600">better before we bring it back.</span></h1>
              <p className="mx-auto mt-6 max-w-2xl text-sm leading-7 text-zinc-600 sm:text-base sm:leading-8">The DateBu website is temporarily in maintenance while we work through university permissions, platform requirements, and feedback from our users. We&apos;re also redesigning parts of the experience based on what we&apos;ve learned.</p>
            </div>
            ...
            <div className="mx-auto mt-8 max-w-4xl rounded-[28px] border border-zinc-200 bg-zinc-950 p-6 text-white shadow-xl shadow-zinc-950/10 sm:p-8">
              <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="shrink-0 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-[10px] font-black uppercase tracking-[0.14em] text-zinc-300">Coming back soon</div>
              </div>
            </div>
            <div className="mx-auto mt-7 flex max-w-4xl items-center justify-center gap-2 text-center text-[11px] font-semibold text-zinc-400"><span>Thanks for your patience.</span><ArrowUpRight className="h-3.5 w-3.5" /><span>DateBu team</span></div>
          </div>
        </section>
