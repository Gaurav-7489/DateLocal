...
export default async function MatchesPage() {
  ...
  const {data:profiles,error:profilesError}=await supabase.rpc("get_match_profiles",{p_user_ids:otherUserIds});
